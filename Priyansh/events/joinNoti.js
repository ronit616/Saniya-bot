...
👋For Any Kind Of Help Contact On Telegram  Username 👉 @𝕊𝕒𝕟𝕚𝕪𝕒 𝕣𝕒𝕛𝕡𝕦𝕥😇 
...
`, attachment: fs.createReadStream(__dirname + "/cache/botjoin.mp4")} ,threadID));
        ...
        try {
            ...
            (typeof threadData.customJoin == "undefined") ? msg = "Hello Mr/Miss {name},\n─────────────────\n You're The {soThanhVien}Member ─────────────────\nOf {threadName} Group\n─────────────────\nPlease Enjoy Your Stay\n─────────────────\nAnd Make Lots Of Friends =)\n──────-°°__𝗧𝗿𝘂𝘀𝘁 𝗺e 🔐 °__!!>☁️✨❤️ My Owner  ✦͙͙͙͙❥⃝∗⁎.ʚ Saniya Rajput ɞ.⁎∗❥⃝**͙✦͙͙͙ ❤️ Love you 😘 ummmma ❤️😍" : msg = threadData.customJoin;
            msg = msg
